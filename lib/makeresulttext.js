...
exports.makeResultText = function(matchlevel, matchname) {
  ...
  var main = '<h3>チーム　＜'
              + team1name
           + '＞</h3>';
  main += ('受け渡しゾーンのオブジェクト: ' + obj['getobj_p1'] + '<br>');
  main += ('支配陣地内のオブジェクト: ' + obj['getobj_f1'] + '<br>');
  main += ('崩した回数: ' + obj['destroy1'] + '<br>');
  main += ('リトライ回数: ' + obj['retry1'] + '<br>');
  main += ('違反回数: ' + obj['invalid1'] + '<br>');
  ...
  main += ('<h3>チーム　＜'
            + team2name
         + '＞</h3>');
  main += ('受け渡しゾーンのオブジェクト: ' + obj['getobj_p2'] + '<br>');
  main += ('支配陣地内のオブジェクト: ' + obj['getobj_f2'] + '<br>');
  main += ('崩した回数: ' + obj['destroy2'] + '<br>');
  main += ('リトライ回数: ' + obj['retry2'] + '<br>');
  main += ('違反回数: ' + obj['invalid2'] + '<br>');
